...
class RubicsCube : public Object {
private:
    GLuint RB_VAO;
    Cube* cubes;
...
public:
    RubicsCube(GLuint VAO) {
        ...
        // HARDCODED for now
        const char* vertex_shader_path = "src/res/shaders/box.vs";
        const char* fragment_shader_path = "src/res/shaders/box.fs";
